<?php
 ...
 $donnees = Membre::affiche_utilisateur();
 //print_r($donnees);
 session_start();
        ...
        <div class="left-sidebar-pro">
            <nav id="sidebar">
                <div class="sidebar-header">
                    ...
                    <h3>Salut, <?php echo $_SESSION["Auth"]->login ?></h3>
                    <p><?php echo $_SESSION["Auth"]->slug ?></p>
                    <strong>AP+</strong>
                </div>
                                    ...
                                    <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                ...
                                                <span class="admin-name"> <?php echo $_SESSION["Auth"]->login ?> </span>
                                                <span class="admin-name"> <a href="deconnecte.php"><button class="btn btn-success btn-md">Deconnexion</button></a> </span>
                                                <span class="admin-name"> <a href="createuser.php"><button class="btn btn-success btn-md">Ajouter utisateur</button></a> </span>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form action="controller.php" method="post">
                                <div class="row">
                                        <div class="col-lg-4">
                                            <?php if(isset($id)){echo $id, $login, $password, $adresse;} ?>
                                            <div class="login-input-head">

                                                <input type="hidden" name="login" class="form-control" value="<?php if(isset($id)){echo $id;}?>"/>
                                                Login
                                                <input type="text" name="login" class="form-control" value="<?php if(isset($login)){echo $login;}?>"/>
                                                password
                                                <input type="text" name="login" class="form-control" value="<?php if(isset($password)){echo $password;}?>"/>
                                                adresse
                                                <input type="text" name="login" class="form-control" value="<?php if(isset($adresse)){echo $adresse;}?>"/>
                                            </div>
                                            <input type="submit" name="enregistrer_modif" class="btn btn-warning" value="Enregistrer les modifications">
                                            <input type="reset" name="annuler" class="btn btn-danger" value="Annuler les modifications">
                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="email" data-editable="true">password</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $k->adresse; ?></td>
                                                    <td><a href="dashboard.php?id=<?php echo $k->id;?>&login=<?php echo $k->login; ?>&password=<?php echo $k->password; ?>&adresse=<?php echo $k->adresse; ?>"><button class="btn btn-primary" name="modifier_membre">Modifier</button> </a>
                                                        <a href="controller.php?id=<?php echo $k->id;?>"><button class="btn btn-danger" name="supprimer_membre">Supprimer</button> </a>
                                                        <td>
                                                </tr>
                                                <?php
                                                    }
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-copy-right">
                        <p>Copyright &#169; 2019 katonge bigga All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
                    </div>
                </div>
            </div>
        </div>
