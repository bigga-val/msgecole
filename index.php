<?php 
    ...
    }elseif ($Auth->user()=="etudiant" || $Auth->user()=="prof") {
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-copy-right">
                        <p>Copyright &#169; 201 Bigga || All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
                    </div>
                </div>
            </div>
        </div>
