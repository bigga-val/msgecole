<?php
    ...
    $comments = Commentaire::afficher_commentaire();
    print_r($comments);
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-copy-right">
                        <p>Copyright &#169; 2019 katonge Bigga All rights reserved. Template by <a href="https://isicom.education">Colorlib</a>.</p>
                    </div>
                </div>
            </div>
        </div>
